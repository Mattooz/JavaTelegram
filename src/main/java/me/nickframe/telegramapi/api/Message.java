...
public class Message implements BotObject {
    ...
    private JSONMessage reply_to_message;
    private String text;
    private Audio audio;
    ...
    public Message(int message_id, User from, int date, Chat chat, User forward_from, Integer forward_date, JSONMessage reply_to_message, String text, Audio audio, Document document, PhotoSize[] photo, Sticker sticker, Video video, Voice voice, String caption, Contact contact, Location location, User new_chat_participant, User left_chat_participant, String new_chat_title, PhotoSize[] new_chat_photo, boolean delete_photo_chat, boolean group_chat_created) {
    ...
    public JSONMessage getReply_to_message() {
        return reply_to_message;
    }

    public void setReply_to_message(JSONMessage reply_to_message) {
        this.reply_to_message = reply_to_message;
    }
